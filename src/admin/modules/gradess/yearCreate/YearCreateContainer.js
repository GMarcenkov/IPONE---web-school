...
class YearCreateContainer extends React.Component {
  ...
  handleGetGrades = async () => {
    await axios
      .get(`${process.env.REACT_APP_BACKEND_ENDPOINT}/grades/year/${this.state.yearId}`)
      .then(response => {
  ...
  handleGetUsers = async () => {
    await axios
      .get(`${process.env.REACT_APP_BACKEND_ENDPOINT}/users/username/${this.state.username}`)
      .then(response => {
  ...
  handleGetTeachers = async () => {
    await axios
      .get(`${process.env.REACT_APP_BACKEND_ENDPOINT}/teacher/username/${this.state.teacher}`)
      .then(response => {
        this.setState({
  ...
  handleSearch = event => {
    ...
    if (this.state.filterByName) {
      ...
      axios
        .get(
          `${process.env.REACT_APP_BACKEND_ENDPOINT}/users/username/${event.target.value.trim()}`
        )
        .then(response => {
  ...
  handleAddSchoolYearToStudent = (student, grade, subGrade, teacher) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_BACKEND_ENDPOINT}/users/addSchoolYear/${student._id}`,
        schoolYear
      )
      .then(() => {});
  };
  handleCreateGrade = async () => {
    ...
    await axios
      .post(`${process.env.REACT_APP_BACKEND_ENDPOINT}/grades/add`, NewGrade)
      .then(response => {
    ...
    await axios
      .post(`${process.env.REACT_APP_BACKEND_ENDPOINT}/studentsInGrade/add`, studentsInGrade)
  ...
  handleDeleteGrade = () => {
    axios
      .delete(`${process.env.REACT_APP_BACKEND_ENDPOINT}/grades/delete/${this.state.gradeId}`)
      .then(this.handleGetGrades);
    this.setState({ editModel: false });
  };
  handleTakeGrade = async (id, grade, subGrade, teacher) => {
    await axios
      .get(`${process.env.REACT_APP_BACKEND_ENDPOINT}/studentsInGrade/${id}`)
      .then(response => {
        this.setState({
