...
class UsersContainer extends React.Component {
  ...
  handleGetUsers = () => {
    axios
      .get(`${process.env.REACT_APP_BACKEND_ENDPOINT}/users/`)
      .then(response => {
  ...
  handleDeleteUser = id => {
    axios
      .delete(`${process.env.REACT_APP_BACKEND_ENDPOINT}/users/delete/${id}`)
  ...
  handleEditUSer = () => {
    ...
    axios
      .put(`${process.env.REACT_APP_BACKEND_ENDPOINT}/users/edit/${selectedUserId}`, user)
      .then(() => this.handleGetUsers());
