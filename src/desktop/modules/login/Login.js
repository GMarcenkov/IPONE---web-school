  ...
  render() {
    return (
      <div className="form">
        ...
        <meta property="og:image:secure_url"        content="How much does culture influence creative thinking?" />
        <meta property="og:description"        content="http://static01.nyt.com/images/2015/02/19/arts/international/19iht-btnumbers19A/19iht-btnumbers19A-facebookJumbo-v2.jpg" />
